...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($pwd === $row['fac_adv_password'] && $row['fac_adv'] == 'YES') {
...
<body>
    ...
    <h2 style="color: white; font-size: 25px;">Faculty Advisor Login</h2>

    <div id="container">
        <form id="registrationForm" action="fac_adv_login.php" method="POST">
