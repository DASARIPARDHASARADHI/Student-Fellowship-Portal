...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['selected_students'], $_POST['approval_status'], $_POST['hod_remarks'])) {
    ...
    $remarks = $_POST['hod_remarks']; // Array of remarks keyed by roll number
